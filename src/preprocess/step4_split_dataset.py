...
## 실제 분할 결과 (3 Class)
- 초기 분할: Train 10,850 / Val 2,325 / Test 2,325 (70/15/15)
- 재분배 후: Train 9,999 / Val 2,750 / Test 2,751 (64.5/17.7/17.7)
- 재분배 사유: Train 데이터 제한으로 검증 데이터 확보

## 재분배
- 필요 시 redistribute_data.py 스크립트 사용
- Train을 원하는 크기로 조정하고 나머지를 Val/Test로 균등 분배
