...
## 클래스 분포 (3 Class)
- helmet: Dataset 1 + Dataset 2 (약 39,000개)
- head: Dataset 1만 (추가 예정)
- vest: Dataset 2만 (약 16,000개)
- 불균형이 있지만 실제 현장 비율과 유사
...
# =============================================================================
# 클래스 ID와 이름 매핑
CLASS_NAMES = {0: 'helmet', 1: 'head', 2: 'vest'}

# 시각화 시 사용할 색상 (BGR 형식)
# 초록색: helmet, 빨간색: head (경고), 주황색: vest
CLASS_COLORS = {0: (0, 255, 0), 1: (0, 0, 255), 2: (255, 165, 0)}
